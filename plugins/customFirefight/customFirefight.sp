...
#include "src/spawn.sp"
#include "src/player.sp"
#include "src/object.sp"
#include "src/objective.sp"
...
public bool LoadCfg() {
	...
	if (!IsVanilla(cfg) && IsModeSupported(cfg)) {
...
public bool IsVanilla(const char[] mode) {
	return StrEqual(mode, FIREFIGHT, false);
}
